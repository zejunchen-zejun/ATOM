...
# export SGLANG_TORCH_PROFILER_DIR=./profile_qwen3_sglang_atom

TORCHINDUCTOR_COMPILE_THREADS=128 CUDA_VISIBLE_DEVICES="4,5,6,7" python3 -m sglang.launch_server \
